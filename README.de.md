...
Die vollständige Methodik, einfache Sprache mit Glossar:
[Methodik-Dokument](docs/study/METHODOLOGY.de.md).


## Datenquellen
Die Sammlung greift auf ein Register von **108 öffentlichen
Quellen** zu — amtliche Statistiken und Produktregister,
Ökolabel- und EPD-Kataloge, Hersteller- und Händlerkataloge,
Branchenverbände — geführt im Werkzeug und vor jeder Sammlung
höflich sondiert: Robots/Bedingungs-Prüfungen, je Quelle ein
Feasibility-Befund, ehrliche «keine Daten»-Einträge mit
strukturellem Grund statt stiller Fehlschläge. Zugriffsdisziplin:
nur öffentlich verfügbare Dokumente, minimale Kosten, kein
Massenabgriff, Crawl-Delay respektiert.

Die kuratierte **`data_sources.csv`** verzeichnet die Quellen mit
bestätigten Bulk-Produktdaten (Bulk + Identitäts-Tupel =
Hersteller + Produkt-Ident): heute **AS-2 EU Ecolabel (≈17'013
distinct Farbprodukte)** und **AS-3 Nordischer Schwan (≈2'322)**;
**AS-33 BASTA** (195'391 Bauartikel über die eigene anonyme
Web-Client-Route) schliesst an, sobald ein serverseitiger
Farbfilter gesteckt ist. Detail:
[Datenquellen](docs/study/DATA_SOURCE.de.md) (einfache Sprache,
Glossar; EN-Elterndokument).


## Projektstand: nächste Schritte (v0.3)
...
## Projektstand: frühere Einheiten, Befunde und Lücken
...
## Das Werkzeug: CLI, Datenbank, Architektur
...
## Weitere Detaildokumentation (Methodik, Architektur, Datenbank)
| Dokument | Inhalt |
|---|---|
