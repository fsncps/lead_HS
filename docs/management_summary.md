# Management Summary — Zusammenfassung (DE) / Résumé (FR)

> **Living document.** Bilingual management summary of the project's purpose,
> method, interim findings, limitations and next steps — German and French.
> To be updated whenever the project's substance changes; linked early in
...
## Deutsch — Zusammenfassung für Entscheidungsträger

### Ausgangslage

Blei wurde in Farben traditionell in drei Rollen eingesetzt: als Farbpigment
...
SR 946.513.8) in Art. 2 auf («Negativliste»). Die **erste Ziffer dieses
Ausnahmekatalogs (Art. 2 Bst. a Ziff. 1) betrifft bleihaltige
Anstrichfarben und Lacke**: Die Schweiz verbietet gestützt auf die
Chemikalien-Risikoreduktions-Verordnung (ChemRRV, Anhang 2.8) Farben mit
...
0,1 % aus; Spuren- und Verunreinigungsblei darunter bleibt unsichtbar —
inklusive des Bereichs zwischen 100 ppm (schweizerisches Verbot) und
1000 ppm (EU-Deklarationsschwelle). Die Qualität der Blätter variiert. Ohne
Labor können diese blinden Flecken nicht experimentell abgeschätzt werden —
sie werden als klar ausgewiesene Einschränkungen dokumentiert.
...
## Français — Résumé à l'attention des décideurs

### Contexte

Le plomb est traditionnellement utilisé dans les peintures sous trois
formes : pigment de couleur (p. ex. chromate de plomb), additif antirouille
...
VIPaV, RS 946.513.8) — la « liste négative ». **La première rubrique de ce
catalogue (art. 2 al. a ch. 1) concerne les peintures et vernis contenant du
plomb** : sur le fondement de l'ordonnance sur la réduction des risques
liés aux produits chimiques (ORRChim, annexe 2.8), la Suisse interdit les
...
qu'à partir de 0,1 % ; le plomb à l'état de traces ou d'impureté en deçà
reste invisible — y compris la plage entre 100 ppm (interdiction suisse) et
1000 ppm (seuil de déclaration UE). La qualité des fiches varie. Sans
laboratoire, ces angles morts ne peuvent être bornés expérimentalement — ils
sont documentés comme restrictions explicitement signalées.
