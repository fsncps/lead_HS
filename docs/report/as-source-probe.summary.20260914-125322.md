...
Run: `20260914-125322` · all 30 AS rows · one finding per source (D37).
...
- records: **100 (exact)**
- basis: reused csv-sample.20260914-111921.AS-2.csv
- artifact: `csv-sample.20260914-111921.AS-2.csv`
- GETs spent: 0

## AS-3 — Nordic Swan Ecolabel product database — delivered

- records: **14 (exact)**
- basis: reused csv-sample.20260914-111921.AS-3.csv
- artifact: `csv-sample.20260914-111921.AS-3.csv`
- GETs spent: 0
