...
Run: `20260914-165555 (rebuilt)` · all 30 AS rows · one finding per source (D37).
...
- basis: reused csv-sample.20260914-164304.AS-2.csv
- artifact: `csv-sample.20260914-164304.AS-2.csv`
- GETs spent: 0

## AS-3 — Nordic Swan Ecolabel product database — delivered

- records: **100 rows (sample of 2,322 distinct register products)**
- basis: reused csv-sample.20260914-164304.AS-3.csv
- artifact: `csv-sample.20260914-164304.AS-3.csv`
- GETs spent: 0

## AS-4 — Blue Angel (Blauer Engel) — records

- records: **≈70000 (estimated)**
- basis: estimate from visible page text (products) on https://www.blauer-engel.de/en/products, accessed 2026-09-14
...
- basis: estimate from visible page text (EPD) on https://environdec.com/library, accessed 2026-09-14
- available instead: per-product EPD downloads via the library search
